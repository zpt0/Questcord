...
export function VersionDisplay() {
    ...
    const checkUpdate = async () => {
        ...
        if (result.error) {
            ...
            setTimeout(() => {
                showUpdateModal(result.latestVersion!, result.releaseNotes || "No release notes available.");
            }, 500);
        } else {
    ...
    const getStatusColor = () => {
        ...
        if (updateStatus.includes("failed") || updateStatus.includes("Failed")) return theme.dangerColor;
