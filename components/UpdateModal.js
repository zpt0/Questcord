...
export function showUpdateModal(version, releaseNotes) {
    ...
    pill.innerHTML = `
        <div class="quest-pill-compact" style="justify-content: center; position: relative; margin-bottom: 12px; width: 100%;">
            <span class="quest-pill-title" style="color: ${isMandatory ? "#ed4245" : "#2dc770"}; font-size: 14px; flex: unset;">QuestCord Update</span>
