...
export function showQuestConflictModal(runningQuestId, newQuestId) {
    return new Promise((resolve) => {
        try {
            ...
            const currentProgress = runningQuest.userStatus?.progress?.[taskName]?.value ?? 0;
